...
public final class AnimationControllerEvaluator {
    ...
    static List<ResourceLocation> eventsBetween(
            AnimationControllerDefinition.State state,
    ...
    private static List<ResourceLocation> orderedEventIds(
    ...
    private record EventOccurrence(double time, ResourceLocation id) {
    }
}