...
/** Triggered when a player turns on a Shadows And Petals lamp. */
public final class LampLitTrigger
        extends SimpleCriterionTrigger<LampLitTrigger.TriggerInstance> {
    @Override
    ...
    public Criterion<TriggerInstance> lampLit() {
