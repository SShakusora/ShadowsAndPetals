 ...
 * <p>
 * Registration is keyed by item registry id ({@link ResourceLocation}). Use
 * {@link #register(ResourceLocation, TooltipModifier)} to attach modifiers;
 * existing entries are merged with {@code andThen}.
 */
@FunctionalInterface
public interface TooltipModifier {
    Map<ResourceLocation, TooltipModifier> REGISTRY = new ConcurrentHashMap<>();
    ...
    static void register(ResourceLocation itemId, TooltipModifier modifier) {
