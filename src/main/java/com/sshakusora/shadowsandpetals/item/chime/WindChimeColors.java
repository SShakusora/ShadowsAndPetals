...
public record WindChimeColors(DyeColor ribbon, DyeColor vane) {
    ...
    public ResourceLocation itemModelId() {
        return ShadowsAndPetals.asResource("wind_chime");
    }

    public static ResourceLocation blockBodyModelId(DyeColor ribbon) {
        return ShadowsAndPetals.asResource("block/wind_chimes/body_" + ribbon.getName());
    }

    public static ResourceLocation blockMainRibbonModelId(DyeColor ribbon) {
        return ShadowsAndPetals.asResource("block/wind_chimes/main_ribbon_" + ribbon.getName());
    }

    public static ResourceLocation blockVaneModelId(DyeColor vane) {
        return ShadowsAndPetals.asResource("block/wind_chimes/vane_" + vane.getName());
    }

    public static ResourceLocation itemBodyModelId() {
        return ShadowsAndPetals.asResource("item/wind_chime/body");
    }

    public static ResourceLocation itemRibbonModelId(DyeColor ribbon) {
        return ShadowsAndPetals.asResource("item/wind_chime/ribbon_" + ribbon.getName());
    }

    public static ResourceLocation itemVaneModelId(DyeColor vane) {
    ...
    public static WindChimeColors fromTag(CompoundTag tag) {
        DyeColor ribbon = DyeColor.byName(tag.getString(RIBBON_TAG), DEFAULT_COLOR);
        DyeColor vane = DyeColor.byName(tag.getString(VANE_TAG), DEFAULT_COLOR);
