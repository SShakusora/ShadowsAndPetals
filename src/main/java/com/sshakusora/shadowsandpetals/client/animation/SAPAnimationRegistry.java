...
public final class SAPAnimationRegistry {
    private static final Map<AnimationResourceRef.Controller, Registration> REGISTRATIONS =
            new LinkedHashMap<>();
    private static final Map<ResourceLocation, UseAnimationProfile> PROFILES =
            new LinkedHashMap<>();
    private static final Map<ResourceLocation, BlockAnimationDefinition> BLOCK_ANIMATIONS =
            new LinkedHashMap<>();
