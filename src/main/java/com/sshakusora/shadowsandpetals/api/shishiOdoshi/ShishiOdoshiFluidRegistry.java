...
public final class ShishiOdoshiFluidRegistry {
    ...
    public static void registerFluid(Fluid fluid, float animationSpeed, ResourceLocation flowingTexture, int tintColor) {
    ...
    public static void registerRenderProperties(Fluid fluid, ResourceLocation flowingTexture, int tintColor) {
    ...
    public record RenderProperties(ResourceLocation flowingTexture, int tintColor) {}
}