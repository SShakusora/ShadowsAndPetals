...
public class WindChimeBlockEntity extends BlockEntity {
    ...
    protected void loadAdditional(CompoundTag input, HolderLookup.Provider registries) {
        ...
        colors = new WindChimeColors(
                DyeColor.byName(input.getString(WindChimeColors.RIBBON_TAG), WindChimeColors.DEFAULT_COLOR),
                DyeColor.byName(input.getString(WindChimeColors.VANE_TAG), WindChimeColors.DEFAULT_COLOR)
        );
    }
