...
public final class RegisterShishiOdoshiFluidsEvent extends Event implements IModBusEvent {
    ...
    public void registerRenderProperties(Fluid fluid, ResourceLocation flowingTexture, int tintColor) {
        ShishiOdoshiFluidRegistry.registerRenderProperties(fluid, flowingTexture, tintColor);
    }

    public void registerFluid(Fluid fluid, float animationSpeed, ResourceLocation flowingTexture, int tintColor) {
